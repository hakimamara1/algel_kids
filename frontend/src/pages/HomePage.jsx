    ...
    return (
        <div className="min-h-screen bg-gray-50 p-6">
            <div className="max-w-7xl mx-auto">
                <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">مجموعتنا</h1>

                {products.length === 0 ? (
                    <div className="text-center text-gray-500">لم يتم العثور على منتجات.</div>
                ) : (
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="p-4">
                                        ...
                                        <p className="text-pink-600 font-bold">{product.price} د.ج</p>
                                    </div>
                                </Link>
                            );
                        })}
